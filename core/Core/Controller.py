...
class Controller(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.label_stepReward.setMargin(1)
        self.globalSettingLayout.addWidget(self.label_stepReward, 3, 0, 1, 2)
        ...
        self.globalSettingLayout.addWidget(self.label_showReward, 5, 0, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.checkBox_showReward, 5, 1, 1, 1)

        self.label_showValue = QtWidgets.QLabel(self.centralwidget)
        self.label_showValue.setObjectName("label_showValue")
        self.globalSettingLayout.addWidget(self.label_showValue, 6, 0, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.checkBox_showValue, 6, 1, 1, 1)

        self.label_showQ = QtWidgets.QLabel(self.centralwidget)
        self.label_showQ.setObjectName("label_showQ")
        self.globalSettingLayout.addWidget(self.label_showQ, 7, 0, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.checkBox_showQ, 7, 1, 1, 1)

        self.label_showPolicy = QtWidgets.QLabel(self.centralwidget)
        self.label_showPolicy.setObjectName("label_showPolicy")
        self.globalSettingLayout.addWidget(self.label_showPolicy, 8, 0, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.checkBox_showPolicy, 8, 1, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.label_showCubePolicy, 9, 0, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.checkBox_showCubePolicy, 9, 1, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.label_showCubePolicyOneStep, 10, 0, 1, 1)
        ...
        self.globalSettingLayout.addWidget(self.checkBox_showCubePolicyOneStep, 10, 1, 1, 1)

        self.comboBox_task = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_task.setObjectName("comboBox_task")
        self.globalSettingLayout.addWidget(self.comboBox_task, 11, 0, 1, 2)
        ...
        self.globalSettingLayout.addWidget(self.pbt_policyColor, 12, 0, 1, 2)

        self.pbt_edit = QtWidgets.QPushButton(self.centralwidget)
        self.pbt_edit.setObjectName("pbt_edit")
        self.globalSettingLayout.addWidget(self.pbt_edit, 13, 0, 1, 2)
    ...
    def retranslateUi(self):
        ...
        self.label_stepReward.setText(_translate("EditorWindow", "每步奖励："))
    ...
    def loadMap(self,filePath):
        ...
        if status != '加载成功':
            ...
            self.label_stepReward.setText('每步奖励：'+str(round(self.map.stepReward,2)))
